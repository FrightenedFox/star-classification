...
```{r load-database, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r df-summary, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
summary(df)
```
...
```{r import-libraries, echo = TRUE, results = FALSE, message = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
library(tidyverse)
library(moments)
library(ggridges)
library(viridis)
...
```{r classes, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
df %>%
  group_by(class) %>%
  count() %>%
...
```{r statistic-functions, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r scatter-alpha-redshift, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r heatmap-pearson, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r 2d-density-distribution, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r z-i-regression, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
ggplot(df, aes(x = `i`, y = `z`)) +
  geom_point() +
  geom_smooth(method = "lm", color = "cyan", fill = "#69b3a2", se = TRUE, level = 0.999) +
...
```{r prepare-data-for-ridges, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r plot-galaxy-ridges-density, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
ggplot(subset(df.wavelengths, Class == "Galaxy"), aes(x = `Intensity`, y = `Wavelength`, fill = ..x..)) +
  ...
  labs(title = 'Galaxy radiation intensity per specturm') +
  theme_ipsum() +
  theme(
...
```{r plot-star-ridges-density, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
ggplot(subset(df.wavelengths, Class == "Star"), aes(x = `Intensity`, y = `Wavelength`, fill = ..x..)) +
  geom_density_ridges_gradient(scale = 1, rel_min_height = 0.0001) +
  scale_fill_viridis(name = "Intensity", option = "D") +
  labs(title = 'Star radiation intensity per specturm') +
  theme_ipsum() +
  theme(
    legend.position = "none",
    panel.spacing = unit(0.1, "lines"),
...
```{r plot-quasar-ridges-density, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
ggplot(subset(df.wavelengths, Class == "Quasar"), aes(x = `Intensity`, y = `Wavelength`, fill = ..x..)) +
  geom_density_ridges_gradient(scale = 1, rel_min_height = 0.0001) +
  scale_fill_viridis(name = "Intensity", option = "D") +
  labs(title = 'Quasar radiation intensity per specturm') +
  theme_ipsum() +
  theme(
    legend.position = "none",
    panel.spacing = unit(0.1, "lines"),
...
```{r avg-total-violin-plots, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
ggplot(df, aes(x = `class`, y = `avg-total`, fill = `class`)) +
  geom_violin() +
  geom_boxplot(width = 0.13, color = "black", fill = "grey", alpha = 1) +
  scale_fill_viridis(discrete = TRUE) +
  labs(title = "Comparison of the object radiation distribution per class",
       x = "",
...
```{r t-test-avg-total, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r redshift-distribution, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r redshift-empirical-cumulative-distribution, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=8, fig.height=4.5, eval = TRUE}
...
Do tabelki również dodajemy kolumnę z odpowiednymi teoretycznymi wartościami rozkładu normalnego.

```{r szereg-rozdzielczy, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
...
```{r norm-and-frequences, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=8, fig.height=6, eval = TRUE}
...
Zauważono, że tylko dla klasu kwazarów wartości praktyczne bardzo różnią się od wartości teoretycznych,
dla pozostałych klas różnica jest o wiele mniejsza.

```{r experiment, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=7, fig.height=7, eval = TRUE}
y.n.samples <- 250
y.sample.size <- 20
...
```{r plot-experiment, message = FALSE, results = FALSE, warning = FALSE, dpi=50, fig.width=8, fig.height=4.5, eval = TRUE}
