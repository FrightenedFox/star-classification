...
```{r classes, message = FALSE, results = FALSE, warning = FALSE, eval = FALSE}
df %>%
  group_by(class) %>%
  count() %>%
...
- **Moment zwykły 3 rzędu**
- **Moment centralny 1 rzędu**
- **Moment centralny 2 rzędu**
- **Moment centralny 3 rzędu**
- **Moment centralny absolutny 1 rzędu**
- **Moment centralny absolutny 2 rzędu**
- **Moment centralny absolutny 3 rzędu**

```{r statistic-functions, eval = FALSE}
...
```{r scatter-alpha-delta, message = FALSE, results = FALSE, warning = FALSE, eval = FALSE}
ggplot(df, aes(x = `alpha`, y = `delta`)) +
  geom_point(cex = 2, col = "#69b3a2", size = 0.5) +
